    ...
    <>
      <div className='flex'>
        <div className='container'>
          <img src="/project1.png" alt="" style={{ maxWidth: '100%', maxHeight: '100%' }} />
          <p>Project 1</p>
        ...
        <div className='container'>
          <img src="/ToDo.png" alt="" style={{ maxWidth: '100%', maxHeight: '100%' }} />
          <p>Project 2</p>
        ...
        <div className='container'>
          <img src="/project3.png" alt="" style={{ maxWidth: '100%', maxHeight: '100%' }} />
          <p>Project 3</p>
        ...
        <div className='container'>
          <img src="/project2.png" alt="" style={{ maxWidth: '100%', maxHeight: '100%' }} />
          <p>Project 4</p>
